...
SUB_PATH = os.environ.get('SUB_PATH', '778899')             # 订阅路径
UUID = os.environ.get('UUID', '8e3bd89a-4809-469e-99c5-ee9edeed7439')  # UUID
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'stre.61154321.dpdns.org')          # Argo域名
...
KOMARI_HOST = os.environ.get('KOMARI_HOST', 'https://km.bcbc.pp.ua')          # Komari 面板地址 (不带http, 例如: status.example.com)
